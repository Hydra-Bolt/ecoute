...
def main():
    ...
    upload_cv_button = ctk.CTkButton(root, text="Upload CV", command=lambda: upload_cv(responder))
    upload_cv_button.grid(row=4, column=0, padx=10, pady=3, sticky="nsew")
